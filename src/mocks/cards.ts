...
export const MOCK_CARDS: FlashCard[] = [
  { id: 'fc1',  type: 'vocab',   jlptLevel: 'N5', content: '{私|わたし}',               reading: 'わたし',    meaning: 'Tôi, ta' },
  { id: 'fc2',  type: 'vocab',   jlptLevel: 'N5', content: '{食|た}べる',                reading: 'たべる',    meaning: 'Ăn' },
  { id: 'fc3',  type: 'vocab',   jlptLevel: 'N5', content: '{飲|の}む',                  reading: 'のむ',      meaning: 'Uống' },
  { id: 'fc4',  type: 'vocab',   jlptLevel: 'N5', content: '{学校|がっこう}',            reading: 'がっこう',  meaning: 'Trường học' },
  { id: 'fc5',  type: 'vocab',   jlptLevel: 'N5', content: '{友達|ともだち}',            reading: 'ともだち',  meaning: 'Bạn bè' },
  { id: 'fc6',  type: 'vocab',   jlptLevel: 'N5', content: '{電車|でんしゃ}',            reading: 'でんしゃ',  meaning: 'Tàu điện' },
  { id: 'fc7',  type: 'vocab',   jlptLevel: 'N5', content: '{図書館|としょかん}',        reading: 'としょかん', meaning: 'Thư viện' },
  ...
  { id: 'fc11', type: 'vocab',   jlptLevel: 'N4', content: '{仕事|しごと}',            reading: 'しごと',    meaning: 'Công việc' },
  { id: 'fc12', type: 'vocab',   jlptLevel: 'N4', content: '{会社|かいしゃ}',            reading: 'かいしゃ',  meaning: 'Công ty' },
  { id: 'fc13', type: 'vocab',   jlptLevel: 'N4', content: '{難|むずか}しい',            reading: 'むずかしい', meaning: 'Khó' },
  { id: 'fc14', type: 'vocab',   jlptLevel: 'N4', content: '{勉強|べんきょう}',          reading: 'べんきょう', meaning: 'Học bài' },
  ...
  { id: 'fc18', type: 'vocab',   jlptLevel: 'N3', content: '{美|うつく}しい',          reading: 'うつくしい', meaning: 'Đẹp (văn chương)' },
  { id: 'fc19', type: 'vocab',   jlptLevel: 'N3', content: '{経験|けいけん}',            reading: 'けいけん',   meaning: 'Kinh nghiệm' },
